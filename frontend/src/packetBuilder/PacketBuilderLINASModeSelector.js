        ...
        return (
            <div className="pt-3 pl-3 d-flex">
                <ListControl name="LINAS" active={this.state.active} onChange={this.onList}>
                    ...
                    <ListGroupItem>
                        <ButtonGroupControl className="d-flex justify-content-center" size="md" name="Filament" selected={this.state.filamentSelect} onChange={this.onFilamentSelectBtn} vertical>
                    ...
                    <ListGroupItem>
                        <ButtonGroupControl className="d-flex justify-content-center" size="md" name="Collector Gain State" selected={this.state.collectorGainState} onChange={this.onCollectorGainStateBtn} vertical>
